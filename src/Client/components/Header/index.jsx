...
const Header = () => {
  ...
  const [activeIndexCategory, setActiveIndexCategory] = useState(null);

  const handleToggle = (index) => {
    if (index === 0) {
      setActiveIndex((prev) => (prev === index ? null : index)); // Toggle mở / đóng
    }
  };

  const handleShowCategory = (id, index) => {
    setProps(id);
    ...
    <div className={cx("header")}>
      ...
      <div className={cx("header_content")}>
        <div className={cx("logo")}>
          <div
            className={cx("icon-section", "response1200")}
          ...
          <div className={cx("logo-icon", "response1200")}>
